...
- Independent CIFAS verification (a fresh check showing the record is clear) is still important — it provides hard documentary evidence. But it should not delay notifying the employer of the removal. CIFAS verification is done by submitting a fresh SAR online at cifas.org.uk — free. It is NOT a letter.
- If the employer refuses to reconsider despite clear evidence, two escalation routes exist simultaneously: (1) Financial Ombudsman Service — challenges how the employer used the CIFAS data, submitted online at financial-ombudsman.org.uk, free; (2) Information Commissioner's Office — challenges the accuracy of the data under UK GDPR Article 5(1)(d), submitted online at ico.org.uk, free. Recommend both when appropriate. Frame FOS as the natural next step, not a threat. Neither is a letter — both are online submissions.

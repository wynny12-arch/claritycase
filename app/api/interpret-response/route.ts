...
- A Monese response may contain two parts in one email: (1) an initial acknowledgment with a complaint reference number and investigator name, and (2) a follow-up confirming the marker has been removed and giving a removal date. If both parts are present, treat the overall response as a marker removal confirmation — that is the outcome that matters. Note the complaint reference number and removal date in the summary.
